...
```{r P25_bands}
est_4 <- 1 / (P25_optim$mle - x * P25_optim$mle ^ 0.75)
se_4 <- abs(1 - 0.75 * x * P25_optim$mle ^ -0.25) * (est_4 ^ 2) / 
  c(P25_optim$hessian) ^ 0.5
P25_bands[, 1] <- est_4 - 1.96 * se_4
P25_bands[, 2] <- est_4 
P25_bands[, 3] <- est_4 + 1.96 * se_4
