...
```{r}
opt_res_normal_A$par
opt_res_normal_B$par
opt_res_log_A$par
opt_res_log_B$par
opt_res_t_A$par
opt_res_t_B$par
...
**KAI: All estimates above are correct well done!**
...
**KAI: All plots above are correct well done!**
...
**KAI: All computations and plots above are correct well done!**
...
**KAI: Is OK you are correct well done! see solution for computations using the generalised likelihood ratio tests!**
